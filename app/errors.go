...
var (
	...
	ErrAppMiddleSOAPRESTVersionMismatch         = errorutil.NewKind("E3214", "AppMiddleSOAPRESTVersionMismatch", "received request is not a SOAP 1.1 request.")
	ErrAppMiddleSOAPRESTReadRequestBody         = errorutil.NewKind("E3215", "AppMiddleSOAPRESTInvalidRequestBody", "failed to read request body. {{body}}")
	ErrAppMiddleSOAPRESTUnmarshalRequestBody    = errorutil.NewKind("E3216", "AppMiddleSOAPRESTUnmarshalRequestBody", "failed to unmarshal request body. {{body}}")
