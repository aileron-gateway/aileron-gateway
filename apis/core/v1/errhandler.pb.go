...
type ErrorHandler struct {
	...
	Kind          string                 `protobuf:"bytes,2,opt,name=Kind,json=kind,proto3" json:"Kind,omitempty"`                   // "ErrorHandler"
...
const file_core_v1_errhandler_proto_rawDesc = "" +
	"\n" +
	"\x18core/v1/errhandler.proto\x12\acore.v1\x1a\x1bbuf/validate/validate.proto\x1a\x16core/v1/template.proto\x1a\x15kernel/resource.proto\"\x9f\x01\n" +
	"\fErrorHandler\x12\x1e\n" +
	"\n" +
