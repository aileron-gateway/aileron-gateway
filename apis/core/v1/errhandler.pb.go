...
type ErrorMessageSpec struct {
	...
	// Default is not set.
	HeaderTemplate map[string]string `protobuf:"bytes,5,rep,name=HeaderTemplate,json=headerTemplate,proto3" json:"HeaderTemplate,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	// [OPTIONAL]
