...
type StaticFileHandlerSpec struct {
	...
	// Default is not set.
	Header map[string]string `protobuf:"bytes,7,rep,name=Header,json=header,proto3" json:"Header,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
