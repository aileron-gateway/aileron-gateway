...
const file_core_v1_httpclient_proto_rawDesc = "" +
	"\n" +
	"\x18core/v1/httpclient.proto\x12\acore.v1\x1a\x1bbuf/validate/validate.proto\x1a\x14kernel/network.proto\x1a\x15kernel/resource.proto\"\x9b\x01\n" +
	"\n" +
	"HTTPClient\x12\x1e\n" +
	"\n" +
	...
	"Transports\"\xa2\x01\n" +
	"\vRetryConfig\x12#\n" +
	"\bMaxRetry\x18\x01 \x01(\rB\a\xbaH\x04*\x02\x18dR\bmaxRetry\x128\n" +
	"\x10MaxContentLength\x18\x02 \x01(\x05B\f\xbaH\t\x1a\a\x18\x80\x80\x80\b(\x00R\x10maxContentLength\x124\n" +
	"\x10RetryStatusCodes\x18\x03 \x03(\x05B\b\xbaH\x05\x92\x01\x02\x18\x01R\x10retryStatusCodesB9Z7github.com/aileron-gateway/aileron-gateway/apis/core/v1b\x06proto3"
