...
type WaiterSpec struct {
	...
	// Types that are assignable to Waiter:
	//
...
func (m *WaiterSpec) GetWaiter() isWaiterSpec_Waiter {
	if m != nil {
		return m.Waiter
	}
	return nil
...
func (x *WaiterSpec) GetFixedBackoff() *FixedBackoffWaiterSpec {
	if x, ok := x.GetWaiter().(*WaiterSpec_FixedBackoff); ok {
...
func (x *WaiterSpec) GetLinearBackoff() *LinearBackoffWaiterSpec {
	if x, ok := x.GetWaiter().(*WaiterSpec_LinearBackoff); ok {
...
func (x *WaiterSpec) GetPolynomialBackoff() *PolynomialBackoffWaiterSpec {
	if x, ok := x.GetWaiter().(*WaiterSpec_PolynomialBackoff); ok {
...
func (x *WaiterSpec) GetExponentialBackoff() *ExponentialBackoffWaiterSpec {
	if x, ok := x.GetWaiter().(*WaiterSpec_ExponentialBackoff); ok {
...
func (x *WaiterSpec) GetExponentialBackoffFullJitter() *ExponentialBackoffFullJitterWaiterSpec {
	if x, ok := x.GetWaiter().(*WaiterSpec_ExponentialBackoffFullJitter); ok {
...
func (x *WaiterSpec) GetExponentialBackoffEqualJitter() *ExponentialBackoffEqualJitterWaiterSpec {
	if x, ok := x.GetWaiter().(*WaiterSpec_ExponentialBackoffEqualJitter); ok {
...
var file_core_v1_resilience_proto_rawDesc = []byte{
...
var (
	...
	file_core_v1_resilience_proto_rawDescData = file_core_v1_resilience_proto_rawDesc
)

func file_core_v1_resilience_proto_rawDescGZIP() []byte {
	file_core_v1_resilience_proto_rawDescOnce.Do(func() {
		file_core_v1_resilience_proto_rawDescData = protoimpl.X.CompressGZIP(file_core_v1_resilience_proto_rawDescData)
	})
...
func file_core_v1_resilience_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_core_v1_resilience_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_core_v1_resilience_proto_rawDesc = nil
