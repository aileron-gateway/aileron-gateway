...
const file_core_v1_httpserver_proto_rawDesc = "" +
	"\n" +
	"\x18core/v1/httpserver.proto\x12\acore.v1\x1a\x1bbuf/validate/validate.proto\x1a\x12core/v1/http.proto\x1a\x19core/v1/httphandler.proto\x1a\x14kernel/network.proto\x1a\x15kernel/resource.proto\"\xbe\x01\n" +
	"\n" +
	"HTTPServer\x12.\n" +
	"\n" +
	...
	"\n" +
	"HTTPServerR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x12+\n" +
	"\x04Spec\x18\x04 \x01(\v2\x17.core.v1.HTTPServerSpecR\x04spec\"\xf8\x03\n" +
	"\x0eHTTPServerSpec\x125\n" +
	"\fErrorHandler\x18\x01 \x01(\v2\x11.kernel.ReferenceR\ferrorHandler\x12\x12\n" +
	"\x04Addr\x18\x02 \x01(\tR\x04addr\x12(\n" +
	"\x0fShutdownTimeout\x18\x03 \x01(\x05R\x0fshutdownTimeout\x123\n" +
	"\n" +
	"HTTPConfig\x18\x04 \x01(\v2\x13.core.v1.HTTPConfigR\n" +
	"httpConfig\x126\n" +
	"\vHTTP2Config\x18\x05 \x01(\v2\x14.core.v1.HTTP2ConfigR\vhttp2Config\x126\n" +
	"\vHTTP3Config\x18\x06 \x01(\v2\x14.core.v1.HTTP3ConfigR\vhttp3Config\x121\n" +
	"\n" +
	"Middleware\x18\a \x03(\v2\x11.kernel.ReferenceR\n" +
	"middleware\x12<\n" +
	"\fVirtualHosts\x18\b \x03(\v2\x18.core.v1.VirtualHostSpecR\fvirtualHosts\x12.\n" +
	"\aProfile\x18\t \x01(\v2\x14.core.v1.ProfileSpecR\aprofile\x12+\n" +
	"\x06Expvar\x18\n" +
	" \x01(\v2\x13.core.v1.ExpvarSpecR\x06expvar\"\xaa\x03\n" +
	"\n" +
	"HTTPConfig\x12@\n" +
	...
	"middleware\x124\n" +
	"\bHandlers\x18\x05 \x03(\v2\x18.core.v1.HTTPHandlerSpecR\bhandlers\"E\n" +
	"\vProfileSpec\x12\x16\n" +
	...
	"\x04Path\x18\x02 \x01(\tR\x04pathB9Z7github.com/aileron-gateway/aileron-gateway/apis/core/v1b\x06proto3"
