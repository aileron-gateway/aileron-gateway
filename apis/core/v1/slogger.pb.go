...
const file_core_v1_slogger_proto_rawDesc = "" +
	"\n" +
	"\x15core/v1/slogger.proto\x12\acore.v1\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/replacer.proto\x1a\x15kernel/resource.proto\"\x95\x01\n" +
	"\aSLogger\x12\x1e\n" +
	"\n" +
	...
	"\x04Spec\x18\x04 \x01(\v2\x14.core.v1.SLoggerSpecR\x04spec\"\x80\x03\n" +
	"\vSLoggerSpec\x12'\n" +
	"\x05Level\x18\x01 \x01(\x0e2\x11.core.v1.LogLevelR\x05level\x124\n" +
	...
	"\vLogFileName\x18\x04 \x01(\tR\vlogFileName\x120\n" +
	"\x13ArchivedFilePattern\x18\x05 \x01(\tR\x13archivedFilePattern\x12\x12\n" +
	"\x04Cron\x18\x06 \x01(\tR\x04cron\x12\x1e\n" +
	"\n" +
	"RotateSize\x18\a \x01(\rR\n" +
	"rotateSize\x12\"\n" +
	"\n" +
	"TimeLayout\x18\b \x01(\tB\x02\x18\x01R\n" +
	"timeLayout\x12\x1a\n" +
	"\bTimeZone\x18\t \x01(\tR\btimeZone\x128\n" +
	"\rCompressLevel\x18\n" +
	...
	"\x05Fatal\x10\x06B9Z7github.com/aileron-gateway/aileron-gateway/apis/core/v1b\x06proto3"
