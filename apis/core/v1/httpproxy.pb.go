...
type CircuitBreaker struct {
	...
	//
	// Types that are assignable to CircuitBreakerCounter:
	//
...
func (m *CircuitBreaker) GetCircuitBreakerCounter() isCircuitBreaker_CircuitBreakerCounter {
	if m != nil {
		return m.CircuitBreakerCounter
	}
	return nil
}

func (x *CircuitBreaker) GetConsecutiveCounter() *ConsecutiveCounterSpec {
	if x, ok := x.GetCircuitBreakerCounter().(*CircuitBreaker_ConsecutiveCounter); ok {
...
func (x *CircuitBreaker) GetCountBasedFixedWindowCounter() *CountBasedFixedWindowCounterSpec {
	if x, ok := x.GetCircuitBreakerCounter().(*CircuitBreaker_CountBasedFixedWindowCounter); ok {
...
func (x *CircuitBreaker) GetTimeBasedFixedWindowCounter() *TimeBasedFixedWindowCounterSpec {
	if x, ok := x.GetCircuitBreakerCounter().(*CircuitBreaker_TimeBasedFixedWindowCounter); ok {
...
func (x *CircuitBreaker) GetCountBasedSlidingWindowCounter() *CountBasedSlidingWindowCounterSpec {
	if x, ok := x.GetCircuitBreakerCounter().(*CircuitBreaker_CountBasedSlidingWindowCounter); ok {
...
func (x *CircuitBreaker) GetTimeBasedSlidingWindowCounter() *TimeBasedSlidingWindowCounterSpec {
	if x, ok := x.GetCircuitBreakerCounter().(*CircuitBreaker_TimeBasedSlidingWindowCounter); ok {
...
var file_core_v1_httpproxy_proto_rawDesc = []byte{
...
var (
	...
	file_core_v1_httpproxy_proto_rawDescData = file_core_v1_httpproxy_proto_rawDesc
)

func file_core_v1_httpproxy_proto_rawDescGZIP() []byte {
	file_core_v1_httpproxy_proto_rawDescOnce.Do(func() {
		file_core_v1_httpproxy_proto_rawDescData = protoimpl.X.CompressGZIP(file_core_v1_httpproxy_proto_rawDescData)
	})
...
func file_core_v1_httpproxy_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_core_v1_httpproxy_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_core_v1_httpproxy_proto_rawDesc = nil
