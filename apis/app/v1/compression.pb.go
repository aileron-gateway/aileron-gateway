...
const file_app_v1_middleware_compression_proto_rawDesc = "" +
	"\n" +
	"#app/v1/middleware/compression.proto\x12\x06app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/resource.proto\"\xdd\x01\n" +
	"\x15CompressionMiddleware\x12-\n" +
	"\n" +
	...
	"\x15CompressionMiddlewareR\x04kind\x12,\n" +
