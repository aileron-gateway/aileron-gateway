...
var file_app_v1_meter_otelmeter_proto_rawDesc = []byte{
...
var (
	...
	file_app_v1_meter_otelmeter_proto_rawDescData = file_app_v1_meter_otelmeter_proto_rawDesc
)

func file_app_v1_meter_otelmeter_proto_rawDescGZIP() []byte {
	file_app_v1_meter_otelmeter_proto_rawDescOnce.Do(func() {
		file_app_v1_meter_otelmeter_proto_rawDescData = protoimpl.X.CompressGZIP(file_app_v1_meter_otelmeter_proto_rawDescData)
	})
...
func file_app_v1_meter_otelmeter_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_app_v1_meter_otelmeter_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_app_v1_meter_otelmeter_proto_rawDesc = nil
