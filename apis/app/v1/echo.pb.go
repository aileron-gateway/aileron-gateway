...
const file_app_v1_handler_echo_proto_rawDesc = "" +
	"\n" +
	"\x19app/v1/handler/echo.proto\x12\x06app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x12core/v1/http.proto\x1a\x15kernel/resource.proto\"\xbf\x01\n" +
	"\vEchoHandler\x12-\n" +
	"\n" +
	...
	"\vEchoHandlerR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x12+\n" +
	"\x04Spec\x18\x04 \x01(\v2\x17.app.v1.EchoHandlerSpecR\x04spec\"\\\n" +
	"\x0fEchoHandlerSpec\x12\x1a\n" +
	"\bPatterns\x18\x01 \x03(\tR\bpatterns\x12-\n" +
	"\aMethods\x18\x02 \x03(\x0e2\x13.core.v1.HTTPMethodR\amethodsB8Z6github.com/aileron-gateway/aileron-gateway/apis/app/v1b\x06proto3"

var (
	file_app_v1_handler_echo_proto_rawDescOnce sync.Once
	file_app_v1_handler_echo_proto_rawDescData []byte
)

func file_app_v1_handler_echo_proto_rawDescGZIP() []byte {
	file_app_v1_handler_echo_proto_rawDescOnce.Do(func() {
		file_app_v1_handler_echo_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_app_v1_handler_echo_proto_rawDesc), len(file_app_v1_handler_echo_proto_rawDesc)))
	})
...
func file_app_v1_handler_echo_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_app_v1_handler_echo_proto_rawDesc), len(file_app_v1_handler_echo_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
