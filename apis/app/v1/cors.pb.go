...
const file_app_v1_middleware_cors_proto_rawDesc = "" +
	"\n" +
	"\x1capp/v1/middleware/cors.proto\x12\x06app.v1\x1a\x12core/v1/http.proto\x1a\x15kernel/resource.proto\"\xa2\x01\n" +
	"\x0eCORSMiddleware\x12\x1e\n" +
	"\n" +
	"APIVersion\x18\x01 \x01(\tR\n" +
	"apiVersion\x12\x12\n" +
	"\x04Kind\x18\x02 \x01(\tR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x12.\n" +
	"\x04Spec\x18\x04 \x01(\v2\x1a.app.v1.CORSMiddlewareSpecR\x04spec\"L\n" +
	"\x12CORSMiddlewareSpec\x126\n" +
	"\n" +
	"CORSPolicy\x18\x01 \x01(\v2\x16.app.v1.CORSPolicySpecR\n" +
	"corsPolicy\"\xcf\x04\n" +
