...
type SOAPRESTMiddlewareSpec struct {
	...
	ExtractStringElement bool `protobuf:"varint,8,opt,name=extractStringElement,proto3" json:"extractStringElement,omitempty"`
	// [OPTIONAL]
	...
	//
	// Default value is [false].
	ExtractBooleanElement bool `protobuf:"varint,9,opt,name=extractBooleanElement,proto3" json:"extractBooleanElement,omitempty"`
	// [OPTIONAL]
	...
	// Default value is [false].
	ExtractIntegerElement bool `protobuf:"varint,10,opt,name=extractIntegerElement,proto3" json:"extractIntegerElement,omitempty"`
	// [OPTIONAL]
	...
	// Default value is [false].
	ExtractFloatElement bool `protobuf:"varint,11,opt,name=extractFloatElement,proto3" json:"extractFloatElement,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
var file_app_v1_middleware_soaprest_proto_rawDesc = string([]byte{
	...
	0x72, 0x43, 0x68, 0x61, 0x72, 0x12, 0x32, 0x0a, 0x14, 0x65, 0x78, 0x74, 0x72, 0x61, 0x63, 0x74,
	...
	0x6e, 0x67, 0x45, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x34, 0x0a, 0x15, 0x65, 0x78, 0x74,
	...
	0x34, 0x0a, 0x15, 0x65, 0x78, 0x74, 0x72, 0x61, 0x63, 0x74, 0x49, 0x6e, 0x74, 0x65, 0x67, 0x65,
	...
	0x65, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x30, 0x0a, 0x13, 0x65, 0x78, 0x74, 0x72, 0x61, 0x63, 0x74,
