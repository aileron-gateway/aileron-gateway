...
var file_app_v1_middleware_soaprest_proto_rawDesc = []byte{
...
var (
	...
	file_app_v1_middleware_soaprest_proto_rawDescData = file_app_v1_middleware_soaprest_proto_rawDesc
)

func file_app_v1_middleware_soaprest_proto_rawDescGZIP() []byte {
	file_app_v1_middleware_soaprest_proto_rawDescOnce.Do(func() {
		file_app_v1_middleware_soaprest_proto_rawDescData = protoimpl.X.CompressGZIP(file_app_v1_middleware_soaprest_proto_rawDescData)
	})
...
var file_app_v1_middleware_soaprest_proto_goTypes = []interface{}{
...
func file_app_v1_middleware_soaprest_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_app_v1_middleware_soaprest_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SOAPRESTMiddleware); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_app_v1_middleware_soaprest_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SOAPRESTMiddlewareSpec); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_app_v1_middleware_soaprest_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_app_v1_middleware_soaprest_proto_rawDesc = nil
