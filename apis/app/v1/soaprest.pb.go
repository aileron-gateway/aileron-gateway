...
const file_app_v1_middleware_soaprest_proto_rawDesc = "" +
	"\n" +
	" app/v1/middleware/soaprest.proto\x12\x06app.v1\x1a\x15kernel/resource.proto\"\xaa\x01\n" +
	"\x12SOAPRESTMiddleware\x12\x1e\n" +
	"\n" +
	"APIVersion\x18\x01 \x01(\tR\n" +
	"apiVersion\x12\x12\n" +
	"\x04Kind\x18\x02 \x01(\tR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x122\n" +
	"\x04Spec\x18\x04 \x01(\v2\x1e.app.v1.SOAPRESTMiddlewareSpecR\x04spec\"\xba\x01\n" +
	"\x16SOAPRESTMiddlewareSpec\x12,\n" +
	"\x06Simple\x18\x01 \x01(\v2\x12.app.v1.SimpleSpecH\x00R\x06simple\x12/\n" +
	"\aRayfish\x18\x02 \x01(\v2\x13.app.v1.RayfishSpecH\x00R\arayfish\x128\n" +
	"\n" +
	"Badgerfish\x18\x03 \x01(\v2\x16.app.v1.BadgerfishSpecH\x00R\n" +
	"badgerfishB\a\n" +
	"\x05Rules\"\xaa\x01\n" +
	"\n" +
	"SimpleSpec\x12\x18\n" +
