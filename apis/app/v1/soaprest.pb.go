...
type SimpleMethodSpec struct {
	...
	// [OPTIONAL]
	// IgnoreUnknownKey if true, ignores undefined or unused JSON attributes rather than error.
	// This option is used in JSON to XML conversion.
	// Default is false.
	IgnoreUnusedKey bool `protobuf:"varint,6,opt,name=IgnoreUnusedKey,json=ignoreUnusedKey,proto3" json:"IgnoreUnusedKey,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SimpleMethodSpec) GetIgnoreUnusedKey() bool {
	if x != nil {
		return x.IgnoreUnusedKey
	}
	return false
}
...
type RayfishMethodSpec struct {
	...
	// This option is used in JSON to XML conversion.
	// Default is false.
	IgnoreUnusedKey bool `protobuf:"varint,7,opt,name=IgnoreUnusedKey,json=ignoreUnusedKey,proto3" json:"IgnoreUnusedKey,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *RayfishMethodSpec) GetIgnoreUnusedKey() bool {
	if x != nil {
		return x.IgnoreUnusedKey
	}
	return false
...
type BadgerfishMethodSpec struct {
	...
	// This option is used in JSON to XML conversion.
	// Default is false.
	IgnoreUnusedKey bool `protobuf:"varint,5,opt,name=IgnoreUnusedKey,json=ignoreUnusedKey,proto3" json:"IgnoreUnusedKey,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *BadgerfishMethodSpec) GetIgnoreUnusedKey() bool {
	if x != nil {
		return x.IgnoreUnusedKey
	}
	return false
...
var file_app_v1_middleware_soaprest_proto_rawDesc = string([]byte{
	...
	0x65, 0x74, 0x68, 0x6f, 0x64, 0x22, 0xda, 0x01, 0x0a, 0x10, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65,
	...
	0x66, 0x65, 0x72, 0x53, 0x68, 0x6f, 0x72, 0x74, 0x12, 0x28, 0x0a, 0x0f, 0x49, 0x67, 0x6e, 0x6f,
	0x72, 0x65, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x0f, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x4b,
	0x65, 0x79, 0x22, 0xf5, 0x01, 0x0a, 0x11, 0x52, 0x61, 0x79, 0x66, 0x69, 0x73, 0x68, 0x4d, 0x65,
	0x74, 0x68, 0x6f, 0x64, 0x53, 0x70, 0x65, 0x63, 0x12, 0x18, 0x0a, 0x07, 0x4e, 0x61, 0x6d, 0x65,
	...
	0x12, 0x28, 0x0a, 0x0f, 0x49, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64,
	0x4b, 0x65, 0x79, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x67, 0x6e, 0x6f, 0x72,
	0x65, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x22, 0xbc, 0x01, 0x0a, 0x14, 0x42,
	0x61, 0x64, 0x67, 0x65, 0x72, 0x66, 0x69, 0x73, 0x68, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x53,
	...
	0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x74, 0x72, 0x69, 0x6d, 0x53, 0x70, 0x61, 0x63, 0x65, 0x12,
	0x28, 0x0a, 0x0f, 0x49, 0x67, 0x6e, 0x6f, 0x72, 0x65, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x4b,
	0x65, 0x79, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f, 0x69, 0x67, 0x6e, 0x6f, 0x72, 0x65,
	0x55, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x4b, 0x65, 0x79, 0x42, 0x38, 0x5a, 0x36, 0x67, 0x69, 0x74,
