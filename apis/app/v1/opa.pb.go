...
const file_app_v1_authz_opa_proto_rawDesc = "" +
	"\n" +
	"\x16app/v1/authz/opa.proto\x12\x06app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/resource.proto\"\xaa\x01\n" +
	"\x12OPAAuthzMiddleware\x12\x1e\n" +
	"\n" +
