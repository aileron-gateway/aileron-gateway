...
const file_app_v1_middleware_tracking_proto_rawDesc = "" +
	"\n" +
	" app/v1/middleware/tracking.proto\x12\x06app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/resource.proto\"\xaa\x01\n" +
	"\x12TrackingMiddleware\x12\x1e\n" +
	"\n" +
	"APIVersion\x18\x01 \x01(\tR\n" +
	"apiVersion\x12\x12\n" +
	"\x04Kind\x18\x02 \x01(\tR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x122\n" +
	"\x04Spec\x18\x04 \x01(\v2\x1e.app.v1.TrackingMiddlewareSpecR\x04spec\"\xef\x01\n" +
	"\x16TrackingMiddlewareSpec\x12G\n" +
	"\x12RequestIDProxyName\x18\x01 \x01(\tB\x17\xbaH\x14r\x122\x10^[0-9a-zA-Z-_]*$R\x12requestIDProxyName\x12C\n" +
	"\x10TraceIDProxyName\x18\x02 \x01(\tB\x17\xbaH\x14r\x122\x10^[0-9a-zA-Z-_]*$R\x10traceIDProxyName\x12G\n" +
	"\x12TraceIDExtractName\x18\x03 \x01(\tB\x17\xbaH\x14r\x122\x10^[0-9a-zA-Z-_]*$R\x12traceIDExtractNameB8Z6github.com/aileron-gateway/aileron-gateway/apis/app/v1b\x06proto3"
