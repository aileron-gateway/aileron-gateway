...
var file_app_v1_tracer_oteltracer_proto_rawDesc = string([]byte{
...
var (
	...
	file_app_v1_tracer_oteltracer_proto_rawDescData []byte
)

func file_app_v1_tracer_oteltracer_proto_rawDescGZIP() []byte {
	file_app_v1_tracer_oteltracer_proto_rawDescOnce.Do(func() {
		file_app_v1_tracer_oteltracer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_app_v1_tracer_oteltracer_proto_rawDesc), len(file_app_v1_tracer_oteltracer_proto_rawDesc)))
	})
...
func file_app_v1_tracer_oteltracer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_app_v1_tracer_oteltracer_proto_rawDesc), len(file_app_v1_tracer_oteltracer_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   0,
