...
const file_app_v1_authn_digest_proto_rawDesc = "" +
	"\n" +
	"\x19app/v1/authn/digest.proto\x12\x06app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/encoding.proto\x1a\x12kernel/crypt.proto\x1a\x15kernel/resource.proto\"\xdd\x01\n" +
	"\x15DigestAuthnMiddleware\x12-\n" +
	"\n" +
	...
	"\x15DigestAuthnMiddlewareR\x04kind\x12,\n" +
