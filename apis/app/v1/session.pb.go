...
const file_app_v1_middleware_session_proto_rawDesc = "" +
	"\n" +
	"\x1fapp/v1/middleware/session.proto\x12\x06app.v1\x1a\x15app/v1/encoding.proto\x1a\x1bbuf/validate/validate.proto\x1a\x12core/v1/http.proto\x1a\x15kernel/resource.proto\"\xd1\x01\n" +
	"\x11SessionMiddleware\x12-\n" +
	"\n" +
	...
	"\x11SessionMiddlewareR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x121\n" +
	"\x04Spec\x18\x04 \x01(\v2\x1d.app.v1.SessionMiddlewareSpecR\x04spec\"\xa7\x03\n" +
	...
	"\aStorage\x18\x03 \x01(\v2\x11.kernel.ReferenceR\astorage\x120\n" +
	"\x06Prefix\x18\x04 \x01(\tB\x18\xbaH\x15r\x132\x11^[0-9a-zA-Z-_:]*$R\x06prefix\x127\n" +
	"\n" +
	"CookieName\x18\x05 \x01(\tB\x17\xbaH\x14r\x122\x10^[0-9a-zA-Z-_]+$R\n" +
	"cookieName\x12+\n" +
	"\x06Cookie\x18\x06 \x01(\v2\x13.core.v1.CookieSpecR\x06cookie\x12<\n" +
	"\rSecureEncoder\x18\a \x01(\v2\x16.app.SecureEncoderSpecR\rsecureEncoder\x12)\n" +
	"\x06Tracer\x18\b \x01(\v2\x11.kernel.ReferenceR\x06tracerB8Z6github.com/aileron-gateway/aileron-gateway/apis/app/v1b\x06proto3"
