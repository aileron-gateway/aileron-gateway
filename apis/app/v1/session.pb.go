...
type SessionMiddlewareSpec struct {
	...
	Storage *kernel.Reference `protobuf:"bytes,1,opt,name=Storage,json=storage,proto3" json:"Storage,omitempty"`
	// [OPTIONAL]
	...
	// Default is not set.
	Prefix string `protobuf:"bytes,2,opt,name=Prefix,json=prefix,proto3" json:"Prefix,omitempty"`
	// [OPTIONAL]
	...
	CookieName string `protobuf:"bytes,3,opt,name=CookieName,json=cookieName,proto3" json:"CookieName,omitempty"`
	// [OPTIONAL]
	// Cookie is the settings of cookie to save session ID and session data.
	// Default values are used when not set.
	Cookie *v1.CookieSpec `protobuf:"bytes,4,opt,name=Cookie,json=cookie,proto3" json:"Cookie,omitempty"`
	// [OPTIONAL]
	// SecureEncoderSpec is encoder setting to securely save session data.
	SecureEncoder *SecureEncoderSpec `protobuf:"bytes,5,opt,name=SecureEncoder,json=secureEncoder,proto3" json:"SecureEncoder,omitempty"`
	// [OPTIONAL]
	...
	Tracer        *kernel.Reference `protobuf:"bytes,6,opt,name=Tracer,json=tracer,proto3" json:"Tracer,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
var file_app_v1_middleware_session_proto_rawDesc = string([]byte{
	...
	,
	...
	,
...
var file_app_v1_middleware_session_proto_depIdxs = []int32{
	...
	4, // 2: app.v1.SessionMiddlewareSpec.Storage:type_name -> kernel.Reference
	5, // 3: app.v1.SessionMiddlewareSpec.Cookie:type_name -> core.v1.CookieSpec
	2, // 4: app.v1.SessionMiddlewareSpec.SecureEncoder:type_name -> app.v1.SecureEncoderSpec
	4, // 5: app.v1.SessionMiddlewareSpec.Tracer:type_name -> kernel.Reference
	6, // 6: app.v1.SecureEncoderSpec.HashAlg:type_name -> kernel.HashAlg
	7, // 7: app.v1.SecureEncoderSpec.CommonKeyCryptType:type_name -> kernel.CommonKeyCryptType
