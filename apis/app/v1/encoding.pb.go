...
const file_app_v1_encoding_proto_rawDesc = "" +
	"\n" +
	"\x15app/v1/encoding.proto\x12\x03app\x1a\x1bbuf/validate/validate.proto\x1a\x12kernel/crypt.proto\x1a\x11kernel/hash.proto\"\xfa\x02\n" +
...
var (
	...
	file_app_v1_encoding_proto_rawDescData []byte
)

func file_app_v1_encoding_proto_rawDescGZIP() []byte {
	file_app_v1_encoding_proto_rawDescOnce.Do(func() {
		file_app_v1_encoding_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_app_v1_encoding_proto_rawDesc), len(file_app_v1_encoding_proto_rawDesc)))
	})
...
func file_app_v1_encoding_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_app_v1_encoding_proto_rawDesc), len(file_app_v1_encoding_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
