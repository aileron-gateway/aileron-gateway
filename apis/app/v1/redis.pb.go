...
const file_app_v1_redis_proto_rawDesc = "" +
	"\n" +
	"\x12app/v1/redis.proto\x12\x06app.v1\x1a\x14kernel/network.proto\x1a\x15kernel/resource.proto\"\x9c\x01\n" +
	"\vRedisClient\x12\x1e\n" +
	"\n" +
