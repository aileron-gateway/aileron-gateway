...
type CSRFMiddlewareSpec struct {
	...
	SkipMethods []v1.HTTPMethod `protobuf:"varint,3,rep,packed,name=SkipMethods,json=skipMethods,proto3,enum=core.v1.HTTPMethod" json:"SkipMethods,omitempty"`
	// [OPTIONAL]
	...
	ProxyHeaderName string `protobuf:"bytes,4,opt,name=ProxyHeaderName,json=proxyHeaderName,proto3" json:"ProxyHeaderName,omitempty"`
	// [OPTIONAL]
	...
	// Default is [false].
	IssueNew bool `protobuf:"varint,5,opt,name=IssueNew,json=issueNew,proto3" json:"IssueNew,omitempty"`
	// [OPTIONAL]
	...
	Secret string `protobuf:"bytes,6,opt,name=Secret,json=secret,proto3" json:"Secret,omitempty"`
	// [OPTIONAL]
	...
	// Default is [20].
	SeedSize int32 `protobuf:"varint,7,opt,name=SeedSize,json=seedSize,proto3" json:"SeedSize,omitempty"`
	// [OPTIONAL]
	...
	HashAlg kernel.HashAlg `protobuf:"varint,8,opt,name=HashAlg,json=hashAlg,proto3,enum=kernel.HashAlg" json:"HashAlg,omitempty"`
...
var file_app_v1_middleware_csrf_proto_rawDesc = string([]byte{
	...
	,
...
var file_app_v1_middleware_csrf_proto_goTypes = []any{
	...
	(v1.HTTPMethod)(0),              // 7: core.v1.HTTPMethod
	(kernel.HashAlg)(0),             // 8: kernel.HashAlg
	(*v1.CookieSpec)(nil),           // 9: core.v1.CookieSpec
}
var file_app_v1_middleware_csrf_proto_depIdxs = []int32{
	...
	7,  // 2: app.v1.CSRFMiddlewareSpec.Methods:type_name -> core.v1.HTTPMethod
	7,  // 3: app.v1.CSRFMiddlewareSpec.SkipMethods:type_name -> core.v1.HTTPMethod
	8,  // 4: app.v1.CSRFMiddlewareSpec.HashAlg:type_name -> kernel.HashAlg
	3,  // 5: app.v1.CSRFMiddlewareSpec.CustomRequestHeader:type_name -> app.v1.CustomRequestHeaderSpec
	4,  // 6: app.v1.CSRFMiddlewareSpec.DoubleSubmitCookies:type_name -> app.v1.DoubleSubmitCookiesSpec
	5,  // 7: app.v1.CSRFMiddlewareSpec.SynchronizerToken:type_name -> app.v1.SynchronizerTokenSpec
	9,  // 8: app.v1.DoubleSubmitCookiesSpec.Cookie:type_name -> core.v1.CookieSpec
	0,  // 9: app.v1.DoubleSubmitCookiesSpec.TokenSource:type_name -> app.v1.TokenSource
	0,  // 10: app.v1.SynchronizerTokenSpec.TokenSource:type_name -> app.v1.TokenSource
