...
const file_app_v1_middleware_header_proto_rawDesc = "" +
	"\n" +
	"\x1eapp/v1/middleware/header.proto\x12\x06app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/resource.proto\x1a\x15kernel/replacer.proto\"\xb2\x01\n" +
	"\x16HeaderPolicyMiddleware\x12\x1e\n" +
	"\n" +
	"APIVersion\x18\x01 \x01(\tR\n" +
	"apiVersion\x12\x12\n" +
	"\x04Kind\x18\x02 \x01(\tR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x126\n" +
	"\x04Spec\x18\x04 \x01(\v2\".app.v1.HeaderPolicyMiddlewareSpecR\x04spec\"\xea\x01\n" +
	"\x1aHeaderPolicyMiddlewareSpec\x12\x1e\n" +
	"\n" +
	"AllowMIMEs\x18\x01 \x03(\tR\n" +
	"allowMIMEs\x12*\n" +
	"\x10MaxContentLength\x18\x02 \x01(\x03R\x10maxContentLength\x12>\n" +
	"\rRequestPolicy\x18\x03 \x01(\v2\x18.app.v1.HeaderPolicySpecR\rrequestPolicy\x12@\n" +
	"\x0eResponsePolicy\x18\x04 \x01(\v2\x18.app.v1.HeaderPolicySpecR\x0eresponsePolicy\"\x9f\x03\n" +
