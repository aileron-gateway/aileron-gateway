...
const file_app_v1_middleware_throttle_proto_rawDesc = "" +
	"\n" +
	" app/v1/middleware/throttle.proto\x12\x06app.v1\x1a\x1bbuf/validate/validate.proto\x1a\x12core/v1/http.proto\x1a\x14kernel/matcher.proto\x1a\x15kernel/resource.proto\"\xaa\x01\n" +
	"\x12ThrottleMiddleware\x12\x1e\n" +
	"\n" +
	"APIVersion\x18\x01 \x01(\tR\n" +
	"apiVersion\x12\x12\n" +
	"\x04Kind\x18\x02 \x01(\tR\x04kind\x12,\n" +
	"\bMetadata\x18\x03 \x01(\v2\x10.kernel.MetadataR\bmetadata\x122\n" +
	"\x04Spec\x18\x04 \x01(\v2\x1e.app.v1.ThrottleMiddlewareSpecR\x04spec\"X\n" +
	"\x16ThrottleMiddlewareSpec\x12>\n" +
	"\rAPIThrottlers\x18\x01 \x03(\v2\x18.app.v1.APIThrottlerSpecR\rapiThrottlers\"\xb9\x03\n" +
	...
	"\bMaxRetry\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x00R\bmaxRetry\x12D\n" +
	...
	"\bFillRate\x18\x03 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\bfillRate\"g\n" +
	"\x0fLeakyBucketSpec\x12'\n" +
	"\n" +
	"BucketSize\x18\x01 \x01(\x05B\a\xbaH\x04\x1a\x02(\x01R\n" +
	"bucketSize\x12+\n" +
	"\fLeakInterval\x18\x02 \x01(\x03B\a\xbaH\x04\"\x02(\x01R\fleakIntervalB8Z6github.com/aileron-gateway/aileron-gateway/apis/app/v1b\x06proto3"
