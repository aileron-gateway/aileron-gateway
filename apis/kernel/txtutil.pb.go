...
const file_kernel_txtutil_proto_rawDesc = "" +
	"\n" +
	"\x14kernel/txtutil.proto\x12\x06kernel\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/encoding.proto\x1a\x11kernel/hash.proto\x1a\x12kernel/crypt.proto\"d\n" +
	"\vMatcherSpec\x12$\n" +
	"\bPatterns\x18\x01 \x03(\tB\b\xbaH\x05\x92\x01\x02\x18\x01R\bpatterns\x12/\n" +
	"\tMatchType\x18\x02 \x01(\x0e2\x11.kernel.MatchTypeR\tmatchType\"\x92\x06\n" +
	"\fReplacerSpec\x12-\n" +
	...
	"\x03Key\x18\x05 \x01(\tB\x06\xbaH\x03\xc8\x01\x01R\x03key*o\n" +
	"\tMatchType\x12\t\n" +
	...
	"\n" +
	"\x06GoHTML\x10\x02B8Z6github.com/aileron-gateway/aileron-gateway/apis/kernelb\x06proto3"
