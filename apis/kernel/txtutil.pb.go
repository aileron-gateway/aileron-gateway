...
type ReplacerSpec struct {
	...
	// Types that are assignable to Replacers:
	//
	//	*ReplacerSpec_Fixed
	//	*ReplacerSpec_Value
	//	*ReplacerSpec_Left
...
func (m *ReplacerSpec) GetReplacers() isReplacerSpec_Replacers {
	if m != nil {
		return m.Replacers
	}
	return nil
...
func (x *ReplacerSpec) GetFixed() *FixedReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Fixed); ok {
		return x.Fixed
	}
	return nil
}
...
func (x *ReplacerSpec) GetValue() *ValueReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Value); ok {
		return x.Value
	}
	return nil
}
...
func (x *ReplacerSpec) GetLeft() *LeftReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Left); ok {
		return x.Left
	}
	return nil
}
...
func (x *ReplacerSpec) GetRight() *RightReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Right); ok {
		return x.Right
	}
	return nil
}
...
func (x *ReplacerSpec) GetTrim() *TrimReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Trim); ok {
		return x.Trim
	}
	return nil
}
...
func (x *ReplacerSpec) GetTrimLeft() *TrimLeftReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_TrimLeft); ok {
		return x.TrimLeft
	}
	return nil
}
...
func (x *ReplacerSpec) GetTrimRight() *TrimRightReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_TrimRight); ok {
		return x.TrimRight
	}
	return nil
}
...
func (x *ReplacerSpec) GetTrimPrefix() *TrimPrefixReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_TrimPrefix); ok {
		return x.TrimPrefix
	}
	return nil
}
...
func (x *ReplacerSpec) GetTrimSuffix() *TrimSuffixReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_TrimSuffix); ok {
		return x.TrimSuffix
	}
	return nil
}
...
func (x *ReplacerSpec) GetEncode() *EncodeReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Encode); ok {
		return x.Encode
	}
	return nil
}
...
func (x *ReplacerSpec) GetHash() *HashReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Hash); ok {
		return x.Hash
	}
	return nil
}
...
func (x *ReplacerSpec) GetRegexp() *RegexpReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Regexp); ok {
		return x.Regexp
	}
	return nil
}
...
func (x *ReplacerSpec) GetExpand() *ExpandReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Expand); ok {
		return x.Expand
	}
	return nil
}
...
func (x *ReplacerSpec) GetEncrypt() *EncryptReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_Encrypt); ok {
		return x.Encrypt
	}
	return nil
}
...
func (x *ReplacerSpec) GetHMAC() *HMACReplacer {
	if x, ok := x.GetReplacers().(*ReplacerSpec_HMAC); ok {
		return x.HMAC
	}
	return nil
}
...
type ValueReplacer struct {
	...
	// Default is not set.
	FromTo map[string]string `protobuf:"bytes,1,rep,name=FromTo,json=fromTo,proto3" json:"FromTo,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
