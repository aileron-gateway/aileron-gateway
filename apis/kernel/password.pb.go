...
const file_kernel_password_proto_rawDesc = "" +
	"\n" +
	"\x15kernel/password.proto\x12\x06kernel\x1a\x1bbuf/validate/validate.proto\x1a\x11kernel/hash.proto\"\x91\x02\n" +
	"\x11PasswordCryptSpec\x12,\n" +
	"\x06BCrypt\x18\x01 \x01(\v2\x12.kernel.BCryptSpecH\x00R\x06bcrypt\x12,\n" +
	"\x06SCrypt\x18\x02 \x01(\v2\x12.kernel.SCryptSpecH\x00R\x06scrypt\x12,\n" +
	"\x06PBKDF2\x18\x03 \x01(\v2\x12.kernel.PBKDF2SpecH\x00R\x06pbkdf2\x12.\n" +
	"\aArgon2i\x18\x04 \x01(\v2\x12.kernel.Argon2SpecH\x00R\aargon2i\x120\n" +
	"\bArgon2id\x18\x05 \x01(\v2\x12.kernel.Argon2SpecH\x00R\bargon2idB\x10\n" +
	"\x0ePasswordCrypts\" \n" +
	"\n" +
	"BCryptSpec\x12\x12\n" +
	"\x04Cost\x18\x01 \x01(\x05R\x04cost\"h\n" +
	"\n" +
	"SCryptSpec\x12\x18\n" +
	"\aSaltLen\x18\x01 \x01(\x05R\asaltLen\x12\f\n" +
	"\x01N\x18\x02 \x01(\x05R\x01n\x12\f\n" +
	"\x01R\x18\x03 \x01(\x05R\x01r\x12\f\n" +
	"\x01P\x18\x04 \x01(\x05R\x01p\x12\x16\n" +
	"\x06KeyLen\x18\x05 \x01(\x05R\x06keyLen\"}\n" +
	"\n" +
	"PBKDF2Spec\x12\x18\n" +
	"\aSaltLen\x18\x01 \x01(\x05R\asaltLen\x12\x12\n" +
	"\x04Iter\x18\x02 \x01(\x05R\x04iter\x12\x16\n" +
	"\x06KeyLen\x18\x03 \x01(\x05R\x06keyLen\x12)\n" +
	"\aHashAlg\x18\x04 \x01(\x0e2\x0f.kernel.HashAlgR\ahashAlg\"\x8e\x01\n" +
	"\n" +
	"Argon2Spec\x12\x18\n" +
	"\aSaltLen\x18\x01 \x01(\rR\asaltLen\x12\x12\n" +
	"\x04Time\x18\x02 \x01(\rR\x04time\x12\x16\n" +
	"\x06Memory\x18\x03 \x01(\rR\x06memory\x12\"\n" +
	"\aThreads\x18\x04 \x01(\rB\b\xbaH\x05*\x03\x18\xff\x01R\athreads\x12\x16\n" +
	"\x06KeyLen\x18\x05 \x01(\rR\x06keyLenB8Z6github.com/aileron-gateway/aileron-gateway/apis/kernelb\x06proto3"
