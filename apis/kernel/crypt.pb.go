...
const file_kernel_crypt_proto_rawDesc = "" +
	"\n" +
	"\x12kernel/crypt.proto\x12\x06kernel\x1a\x1bbuf/validate/validate.proto\x1a\x11kernel/hash.proto\"\x91\x02\n" +
	...
	"\x06KeyLen\x18\x05 \x01(\rR\x06keyLen*\xf0\x01\n" +
	...
	"\n" +
	"\x06AESOFB\x10\x05\x12\n" +
	"\n" +
	"\x06DESCBC\x10\x06\x12\n" +
	"\n" +
	"\x06DESCFB\x10\a\x12\n" +
	"\n" +
	"\x06DESCTR\x10\b\x12\n" +
	"\n" +
	"\x06DESOFB\x10\t\x12\x10\n" +
	"\fTripleDESCBC\x10\n" +
	"\x12\x10\n" +
	"\fTripleDESCFB\x10\v\x12\x10\n" +
	"\fTripleDESCTR\x10\f\x12\x10\n" +
	"\fTripleDESOFB\x10\r\x12\a\n" +
	"\x03RC4\x10\x0eB8Z6github.com/aileron-gateway/aileron-gateway/apis/kernelb\x06proto3"
