...
type PasswordCryptSpec struct {
	...
	// Types that are assignable to PasswordCrypts:
	//
...
func (m *PasswordCryptSpec) GetPasswordCrypts() isPasswordCryptSpec_PasswordCrypts {
	if m != nil {
		return m.PasswordCrypts
	}
	return nil
}

func (x *PasswordCryptSpec) GetBCrypt() *BCryptSpec {
	if x, ok := x.GetPasswordCrypts().(*PasswordCryptSpec_BCrypt); ok {
		return x.BCrypt
	}
	return nil
}
...
func (x *PasswordCryptSpec) GetSCrypt() *SCryptSpec {
	if x, ok := x.GetPasswordCrypts().(*PasswordCryptSpec_SCrypt); ok {
		return x.SCrypt
	}
	return nil
}
...
func (x *PasswordCryptSpec) GetPBKDF2() *PBKDF2Spec {
	if x, ok := x.GetPasswordCrypts().(*PasswordCryptSpec_PBKDF2); ok {
		return x.PBKDF2
	}
	return nil
}
...
func (x *PasswordCryptSpec) GetArgon2I() *Argon2Spec {
	if x, ok := x.GetPasswordCrypts().(*PasswordCryptSpec_Argon2I); ok {
		return x.Argon2I
	}
	return nil
}
...
func (x *PasswordCryptSpec) GetArgon2Id() *Argon2Spec {
	if x, ok := x.GetPasswordCrypts().(*PasswordCryptSpec_Argon2Id); ok {
		return x.Argon2Id
	}
	return nil
}
