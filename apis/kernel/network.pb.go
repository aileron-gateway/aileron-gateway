...
const file_kernel_network_proto_rawDesc = "" +
	"\n" +
	"\x14kernel/network.proto\x12\x06kernel\x1a\x1bbuf/validate/validate.proto\"\xfa\x06\n" +
	...
	" \x01(\x03R\x15expectContinueTimeout\x12f\n" +
	"\x13ProxyConnectHeaders\x18\v \x03(\v24.kernel.HTTPTransportConfig.ProxyConnectHeadersEntryR\x13proxyConnectHeaders\x126\n" +
	...
	"dialConfig\x1aF\n" +
	"\x18ProxyConnectHeadersEntry\x12\x10\n" +
	...
	"\x11MinLookupInterval\x18\x0f \x01(\rR\x11minLookupInterval\"\xd6\x02\n" +
	"\n" +
	"DialConfig\x12/\n" +
	"\tTLSConfig\x18\x01 \x01(\v2\x11.kernel.TLSConfigR\ttlsConfig\x12\"\n" +
	"\fLocalNetwork\x18\x03 \x01(\tR\flocalNetwork\x12\"\n" +
	"\fLocalAddress\x18\x04 \x01(\tR\flocalAddress\x12[\n" +
	"\x0eReplaceTargets\x18\x05 \x03(\tB3\xbaH0\x92\x01-\"+r)2'^\\([\\w:\\-]+\\|.+\\)[ >]*\\([\\w:\\-]+\\|.+\\)$R\x0ereplaceTargets\x12\x18\n" +
	"\aTimeout\x18\x06 \x01(\x05R\atimeout\x12$\n" +
	"\rFallbackDelay\x18\a \x01(\x05R\rfallbackDelay\x122\n" +
	"\n" +
	"SockOption\x18\b \x01(\v2\x12.kernel.SockOptionR\n" +
	"sockOption\"\x8d\x02\n" +
	...
	"\x16MaxResponseHeaderBytes\x18\x05 \x01(\x03R\x16maxResponseHeaderBytes\"\x9c\x03\n" +
	"\fListenConfig\x12/\n" +
	"\tTLSConfig\x18\x01 \x01(\v2\x11.kernel.TLSConfigR\ttlsConfig\x12\x18\n" +
	...
	"\bNetworks\x18\x06 \x03(\tB\b\xbaH\x05\x92\x01\x02\x18\x01R\bnetworks\x12\x1c\n" +
	"\tBlacklist\x18\a \x01(\bR\tblacklist\x12\"\n" +
	...
	"\x05Count\x18\x04 \x01(\x05R\x05count\"\x92\x02\n" +
	"\n" +
	"SockOption\x120\n" +
	...
	"\tUDPOption\x18\x05 \x01(\v2\x15.kernel.SockUDPOptionR\tudpOption\"\xda\x03\n" +
	"\fSockSOOption\x12\"\n" +
	"\fBindToDevice\x18\x01 \x01(\tR\fbindToDevice\x12\x14\n" +
	"\x05Debug\x18\x02 \x01(\bR\x05debug\x12 \n" +
	"\vIncomingCPU\x18\x03 \x01(\bR\vincomingCPU\x12\x1c\n" +
	...
	"\x0eReceiveTimeout\x18\t \x01(\x01R\x0ereceiveTimeout\x12 \n" +
	"\vSendTimeout\x18\n" +
	" \x01(\x01R\vsendTimeout\x12\x1c\n" +
	"\tReuseAddr\x18\v \x01(\bR\treuseAddr\x12\x1c\n" +
	"\tReusePort\x18\f \x01(\bR\treusePort\x12\x1e\n" +
	"\n" +
	"SendBuffer\x18\r \x01(\x05R\n" +
	"sendBuffer\x12(\n" +
	"\x0fSendBufferForce\x18\x0e \x01(\x05R\x0fsendBufferForce\"\x86\x02\n" +
	"\fSockIPOption\x12,\n" +
	"\x11BindAddressNoPort\x18\x01 \x01(\bR\x11bindAddressNoPort\x12\x1a\n" +
	"\bFreeBind\x18\x02 \x01(\bR\bfreeBind\x12;\n" +
	"\x13LocalPortRangeUpper\x18\x03 \x01(\x05B\t\xbaH\x06\x1a\x04\x18\xff\xff\x03R\x13localPortRangeUpper\x12;\n" +
	"\x13LocalPortRangeLower\x18\x04 \x01(\x05B\t\xbaH\x06\x1a\x04\x18\xff\xff\x03R\x13localPortRangeLower\x12 \n" +
	...
	"\x03GRO\x18\x03 \x01(\bR\x03gro\"\xc1\x06\n" +
	"\tTLSConfig\x127\n" +
	...
	"\rRenegotiation\x18\x0e \x01(\x0e2\x1c.kernel.RenegotiationSupportR\rrenegotiation\x12:\n" +
	"\x18RootCAsIgnoreSystemCerts\x18\x0f \x01(\bR\x18rootCAsIgnoreSystemCerts\x12>\n" +
	"\x1aClientCAsIgnoreSystemCerts\x18\x10 \x01(\bR\x1aclientCAsIgnoreSystemCerts\"C\n" +
	"\vCertKeyPair\x12\x1a\n" +
	"\bCertFile\x18\x01 \x01(\tR\bcertFile\x12\x18\n" +
	"\aKeyFile\x18\x02 \x01(\tR\akeyFile\"\xb6\x05\n" +
	"\n" +
	"QuicConfig\x12:\n" +
	"\bVersions\x18\x01 \x03(\x0e2\x14.kernel.QuickVersionB\b\xbaH\x05\x92\x01\x02\x18\x01R\bversions\x122\n" +
	...
	"\x0fEnableDatagrams\x18\r \x01(\bR\x0fenableDatagrams*\x93\x01\n" +
	"\vNetworkType\x12\b\n" +
