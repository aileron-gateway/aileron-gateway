...
const file_kernel_network_proto_rawDesc = "" +
	"\n" +
	"\x14kernel/network.proto\x12\x06kernel\x1a\x1bbuf/validate/validate.proto\x1a\x15kernel/sockopts.proto\"\xca\x05\n" +
	"\x13HTTPTransportConfig\x12/\n" +
	"\tTLSConfig\x18\x01 \x01(\v2\x11.kernel.TLSConfigR\ttlsConfig\x120\n" +
	"\x13TLSHandshakeTimeout\x18\x02 \x01(\x03R\x13tlsHandshakeTimeout\x12,\n" +
	"\x11DisableKeepAlives\x18\x03 \x01(\bR\x11disableKeepAlives\x12.\n" +
	"\x12DisableCompression\x18\x04 \x01(\bR\x12disableCompression\x12\"\n" +
	"\fMaxIdleConns\x18\x05 \x01(\x05R\fmaxIdleConns\x120\n" +
	"\x13MaxIdleConnsPerHost\x18\x06 \x01(\x05R\x13maxIdleConnsPerHost\x12(\n" +
	"\x0fMaxConnsPerHost\x18\a \x01(\x05R\x0fmaxConnsPerHost\x12(\n" +
	"\x0fIdleConnTimeout\x18\b \x01(\x03R\x0fidleConnTimeout\x124\n" +
	"\x15ResponseHeaderTimeout\x18\t \x01(\x03R\x15responseHeaderTimeout\x124\n" +
	"\x15ExpectContinueTimeout\x18\n" +
	" \x01(\x03R\x15expectContinueTimeout\x126\n" +
	"\x16MaxResponseHeaderBytes\x18\f \x01(\x03R\x16maxResponseHeaderBytes\x12(\n" +
	"\x0fWriteBufferSize\x18\r \x01(\x05R\x0fwriteBufferSize\x12&\n" +
	"\x0eReadBufferSize\x18\x0e \x01(\x05R\x0ereadBufferSize\x12\x1e\n" +
	"\n" +
	"AllowHTTP2\x18\x0f \x01(\bR\n" +
	"allowHTTP2\x122\n" +
	"\n" +
	"DialConfig\x18\x10 \x01(\v2\x12.kernel.DialConfigR\n" +
	"dialConfig\"\xd9\x05\n" +
	"\x14HTTP2TransportConfig\x12/\n" +
	"\tTLSConfig\x18\x01 \x01(\v2\x11.kernel.TLSConfigR\ttlsConfig\x12.\n" +
	"\x12DisableCompression\x18\x02 \x01(\bR\x12disableCompression\x12\x1c\n" +
	"\tAllowHTTP\x18\x03 \x01(\bR\tallowHTTP\x12,\n" +
	"\x11MaxHeaderListSize\x18\x04 \x01(\rR\x11maxHeaderListSize\x12*\n" +
	"\x10MaxReadFrameSize\x18\x05 \x01(\rR\x10maxReadFrameSize\x12<\n" +
	"\x19MaxDecoderHeaderTableSize\x18\x06 \x01(\rR\x19maxDecoderHeaderTableSize\x12<\n" +
	"\x19MaxEncoderHeaderTableSize\x18\a \x01(\rR\x19maxEncoderHeaderTableSize\x12>\n" +
	"\x1aStrictMaxConcurrentStreams\x18\b \x01(\bR\x1astrictMaxConcurrentStreams\x12(\n" +
	"\x0fIdleConnTimeout\x18\t \x01(\rR\x0fidleConnTimeout\x12(\n" +
	"\x0fReadIdleTimeout\x18\n" +
	" \x01(\rR\x0freadIdleTimeout\x12 \n" +
	"\vPingTimeout\x18\v \x01(\rR\vpingTimeout\x12*\n" +
	"\x10WriteByteTimeout\x18\f \x01(\rR\x10writeByteTimeout\x122\n" +
	"\n" +
	"DialConfig\x18\r \x01(\v2\x12.kernel.DialConfigR\n" +
	"dialConfig\x12(\n" +
	"\x0fMultiIPConnPool\x18\x0e \x01(\bR\x0fmultiIPConnPool\x12,\n" +
	"\x11MinLookupInterval\x18\x0f \x01(\rR\x11minLookupInterval\"\xb2\x02\n" +
	"\n" +
	"DialConfig\x12/\n" +
	"\tTLSConfig\x18\x01 \x01(\v2\x11.kernel.TLSConfigR\ttlsConfig\x12\"\n" +
	"\fLocalAddress\x18\x02 \x01(\tR\flocalAddress\x12[\n" +
	"\x0eReplaceTargets\x18\x03 \x03(\tB3\xbaH0\x92\x01-\"+r)2'^\\([\\w:\\-]+\\|.+\\)[ >]*\\([\\w:\\-]+\\|.+\\)$R\x0ereplaceTargets\x12\x18\n" +
	"\aTimeout\x18\x04 \x01(\x05R\atimeout\x12$\n" +
	"\rFallbackDelay\x18\x05 \x01(\x05R\rfallbackDelay\x122\n" +
	"\n" +
	"SockOption\x18\x06 \x01(\v2\x12.kernel.SockOptionR\n" +
	"sockOption\"\x8d\x02\n" +
	"\x14HTTP3TransportConfig\x12/\n" +
	"\tTLSConfig\x18\x01 \x01(\v2\x11.kernel.TLSConfigR\ttlsConfig\x122\n" +
	"\n" +
	"QuicConfig\x18\x02 \x01(\v2\x12.kernel.QuicConfigR\n" +
	"quicConfig\x12.\n" +
	...
	"\bInterval\x18\x03 \x01(\x05R\binterval\x12\x14\n" +
	"\x05Count\x18\x04 \x01(\x05R\x05count\"\xc5\x05\n" +
	"\tTLSConfig\x127\n" +
	"\fCertKeyPairs\x18\x01 \x03(\v2\x13.kernel.CertKeyPairR\fcertKeyPairs\x12\"\n" +
	"\aRootCAs\x18\x02 \x03(\tB\b\xbaH\x05\x92\x01\x02\x18\x01R\arootCAs\x12\x1e\n" +
	"\n" +
	"NextProtos\x18\x03 \x03(\tR\n" +
	"nextProtos\x12\x1e\n" +
	"\n" +
	"ServerName\x18\x04 \x01(\tR\n" +
	"serverName\x126\n" +
	"\n" +
	"ClientAuth\x18\x05 \x01(\x0e2\x16.kernel.ClientAuthTypeR\n" +
	"clientAuth\x12&\n" +
	"\tClientCAs\x18\x06 \x03(\tB\b\xbaH\x05\x92\x01\x02\x18\x01R\tclientCAs\x12.\n" +
	"\x12InsecureSkipVerify\x18\a \x01(\bR\x12insecureSkipVerify\x120\n" +
	"\n" +
	"TLSCiphers\x18\b \x03(\x0e2\x11.kernel.TLSCipherR\ttlsCipher\x126\n" +
	"\x16SessionTicketsDisabled\x18\t \x01(\bR\x16sessionTicketsDisabled\x12)\n" +
	"\n" +
	"MinVersion\x18\n" +
	" \x01(\rB\t\xbaH\x06*\x04\x18\xff\xff\x03R\n" +
	"minVersion\x12)\n" +
	"\n" +
	"MaxVersion\x18\v \x01(\rB\t\xbaH\x06*\x04\x18\xff\xff\x03R\n" +
	"maxVersion\x12E\n" +
	"\x10CurvePreferences\x18\f \x03(\x0e2\x0f.kernel.CurveIDB\b\xbaH\x05\x92\x01\x02\x18\x01R\x10curvePreferences\x12@\n" +
	"\x1bDynamicRecordSizingDisabled\x18\r \x01(\bR\x1bdynamicRecordSizingDisabled\x12B\n" +
	"\rRenegotiation\x18\x0e \x01(\x0e2\x1c.kernel.RenegotiationSupportR\rrenegotiation\"C\n" +
	"\vCertKeyPair\x12\x1a\n" +
	"\bCertFile\x18\x01 \x01(\tR\bcertFile\x12\x18\n" +
	"\aKeyFile\x18\x02 \x01(\tR\akeyFile\"\xe3\x05\n" +
	"\n" +
	"QuicConfig\x12@\n" +
	"\bVersions\x18\x01 \x03(\x0e2\x1a.kernel.QuicConfig.VersionB\b\xbaH\x05\x92\x01\x02\x18\x01R\bversions\x122\n" +
	"\x14HandshakeIdleTimeout\x18\x02 \x01(\x03R\x14handshakeIdleTimeout\x12&\n" +
	"\x0eMaxIdleTimeout\x18\x03 \x01(\x03R\x0emaxIdleTimeout\x12>\n" +
	"\x1aInitialStreamReceiveWindow\x18\x04 \x01(\x04R\x1ainitialStreamReceiveWindow\x126\n" +
	"\x16MaxStreamReceiveWindow\x18\x05 \x01(\x04R\x16maxStreamReceiveWindow\x12F\n" +
	"\x1eInitialConnectionReceiveWindow\x18\x06 \x01(\x04R\x1einitialConnectionReceiveWindow\x12>\n" +
	"\x1aMaxConnectionReceiveWindow\x18\a \x01(\x04R\x1amaxConnectionReceiveWindow\x12.\n" +
	"\x12MaxIncomingStreams\x18\b \x01(\x03R\x12maxIncomingStreams\x124\n" +
	"\x15MaxIncomingUniStreams\x18\t \x01(\x03R\x15maxIncomingUniStreams\x12(\n" +
	"\x0fKeepAlivePeriod\x18\n" +
	" \x01(\x03R\x0fkeepAlivePeriod\x128\n" +
	"\x17DisablePathMTUDiscovery\x18\v \x01(\bR\x17disablePathMTUDiscovery\x12\x1c\n" +
	"\tAllow0RTT\x18\f \x01(\bR\tallow0RTT\x12(\n" +
	"\x0fEnableDatagrams\x18\r \x01(\bR\x0fenableDatagrams\"%\n" +
	"\aVersion\x12\f\n" +
	"\bVersion1\x10\x00\x12\f\n" +
	"\bVersion2\x10\x01*\x93\x01\n" +
	"\vNetworkType\x12\b\n" +
	...
	"\n" +
	"UnixPacket\x10\f*\x90\x01\n" +
	"\x0eClientAuthType\x12\x10\n" +
	"\fNoClientCert\x10\x00\x12\x15\n" +
	"\x11RequestClientCert\x10\x01\x12\x18\n" +
	"\x14RequireAnyClientCert\x10\x02\x12\x1b\n" +
	"\x17VerifyClientCertIfGiven\x10\x03\x12\x1e\n" +
	"\x1aRequireAndVerifyClientCert\x10\x04*h\n" +
	"\x14RenegotiationSupport\x12\x14\n" +
	"\x10RenegotiateNever\x10\x00\x12\x1b\n" +
	"\x17RenegotiateOnceAsClient\x10\x01\x12\x1d\n" +
	"\x19RenegotiateFreelyAsClient\x10\x02*B\n" +
	"\aCurveID\x12\r\n" +
	"\tCurveP256\x10\x00\x12\r\n" +
	"\tCurveP384\x10\x01\x12\r\n" +
	"\tCurveP521\x10\x02\x12\n" +
	"\n" +
	"\x06X25519\x10\x03*\xc9\b\n" +
	"\tTLSCipher\x12\x1c\n" +
	"\x18TLS_RSA_WITH_RC4_128_SHA\x10\x00\x12!\n" +
	"\x1dTLS_RSA_WITH_3DES_EDE_CBC_SHA\x10\x01\x12 \n" +
	"\x1cTLS_RSA_WITH_AES_128_CBC_SHA\x10\x02\x12 \n" +
	"\x1cTLS_RSA_WITH_AES_256_CBC_SHA\x10\x03\x12#\n" +
	"\x1fTLS_RSA_WITH_AES_128_CBC_SHA256\x10\x04\x12#\n" +
	"\x1fTLS_RSA_WITH_AES_128_GCM_SHA256\x10\x05\x12#\n" +
	"\x1fTLS_RSA_WITH_AES_256_GCM_SHA384\x10\x06\x12$\n" +
	" TLS_ECDHE_ECDSA_WITH_RC4_128_SHA\x10\a\x12(\n" +
	"$TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA\x10\b\x12(\n" +
	"$TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA\x10\t\x12\"\n" +
	"\x1eTLS_ECDHE_RSA_WITH_RC4_128_SHA\x10\n" +
	"\x12'\n" +
	"#TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA\x10\v\x12&\n" +
	"\"TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA\x10\f\x12&\n" +
	"\"TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA\x10\r\x12+\n" +
	"'TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256\x10\x0e\x12)\n" +
	"%TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256\x10\x0f\x12)\n" +
	"%TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256\x10\x10\x12+\n" +
	"'TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256\x10\x11\x12)\n" +
	"%TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384\x10\x12\x12+\n" +
	"'TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384\x10\x13\x12/\n" +
	"+TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256\x10\x14\x121\n" +
	"-TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256\x10\x15\x12\x1a\n" +
	"\x16TLS_AES_128_GCM_SHA256\x10\x16\x12\x1a\n" +
	"\x16TLS_AES_256_GCM_SHA384\x10\x17\x12 \n" +
	"\x1cTLS_CHACHA20_POLY1305_SHA256\x10\x18\x12\x15\n" +
	"\x11TLS_FALLBACK_SCSV\x10\x19\x12(\n" +
	"$TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305\x10\x1a\x12*\n" +
	"&TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305\x10\x1bB8Z6github.com/aileron-gateway/aileron-gateway/apis/kernelb\x06proto3"
