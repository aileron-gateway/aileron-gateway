...
func TestGzipLevel9(t *testing.T) {
	configs := []string{"./config-gzip-level9.yaml"}
...
func TestBrotliLevel1(t *testing.T) {
	configs := []string{"./config-brotli-level1.yaml"}
...
func TestBrotliLevel12(t *testing.T) {
	configs := []string{"./config-brotli-level12.yaml"}
...
func TestAccept_gzip(t *testing.T) {
	configs := []string{"./config-accept.yaml"}
...
func TestAccept_brotli(t *testing.T) {
	configs := []string{"./config-accept.yaml"}
	...
	r1 := httptest.NewRequest(http.MethodGet, "/", nil)
	r1.Header.Set("Accept-Encoding", "br")
